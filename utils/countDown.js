...
function Countdown(options) {
  ...
  this.done = options.done || function(options) {
    console.log(options)
  };
  this.start = options.start || function(flag) {
    console.log(flag)
  };
...
Countdown.prototype = {
  ...
  dateformat: function(micro_second) {
    ...
    //return (day > 0 ? day + '天' : '') + this.add0(hr) + "时" + this.add0(min) + "分";
    return (day > 0 ? day + '天' : '') + this.add0(hr) + "时" + this.add0(min) + "分" + this.add0(sec) + "秒";
  },
